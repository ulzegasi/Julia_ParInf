...
After discretizing the time of the original problem, we are led to a problem akin to the statistical mechanics of a polymer %-like problem
...
%We posit that parameters must be non-negative; otherwise we assume no additional prior knowledge (i.e., the posterior is ‘data-driven’ \cite{box_2011_bayesian}).
...
%The physical time (horizontal axis) is interpreted as a spatial dimension.
