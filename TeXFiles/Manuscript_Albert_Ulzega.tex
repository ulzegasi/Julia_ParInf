...
%Here we present a Monte Carlo-based method for Bayesian parameter inference with generic one dimensional SDE models to tackle the generic problems of calibrating the model to given data time series while simultaneously quantifying the ensuing parametric uncertainty.
...
\vspace{2pc}
\noindent{\it Keywords}: Bayesian parameter inference, Hamiltonian Monte Carlo, time series analysis, stochastic differential equations, path-integrals
