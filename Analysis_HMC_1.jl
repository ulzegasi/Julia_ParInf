...
dir      = "C:/Users/ulzegasi/SWITCHdrive/JuliaTemp/Testing_s5_n10_j40_k50"
...
M_theta        = [params[findin(params[:,1],["M_theta_K"]),2][1], params[findin(params[:,1],["M_theta_gamma"]),2][1]] 
M_stage_burnin = params[findin(params[:,1],["M_stage_burnin"]),2][1]
M_stage        = params[findin(params[:,1],["M_stage"]),2][1]
