...
## ============================================================================================
##
q            = zeros(N)                 # Coordinates and rain input arrays
u            = zeros(N)
r            = zeros(N)
...
bq           = zeros(n+1)               # bq = beta*q = ln(S/(true_k*r)) # = ln(y/r) #

mp           = zeros(params+N)          # Masses and momenta
p            = zeros(params+N)
...
for i = 1:(N-1)                            # Logarithmic derivative of rain input                
...
plt.plot(t[ty], q[ty], "go",markersize=6)
=#
#=
